...
static struct ufs_sfr_log ufs_cfg_log_sfr[] = {
	...
	{"COMN 0x2f"			,	(0x2f<<2),			0},
	{"COMN 0x30"			,	(0x30<<2),			0},
	{"TRSV 0x31"			,	PHY_PMA_TRSV_ADDR(0x31, 0),			0},
	{"TRSV 0x31"			,	PHY_PMA_TRSV_ADDR(0x31, 1),			0},
	{"TRSV 0x32"			,	PHY_PMA_TRSV_ADDR(0x32, 0),			0},
	{"TRSV 0x32"			,	PHY_PMA_TRSV_ADDR(0x32, 1),			0},
	{"TRSV 0x33"			,	PHY_PMA_TRSV_ADDR(0x33, 0),			0},
	{"TRSV 0x33"			,	PHY_PMA_TRSV_ADDR(0x33, 1),			0},
	{"TRSV 0x34"			,	PHY_PMA_TRSV_ADDR(0x34, 0),			0},
	{"TRSV 0x34"			,	PHY_PMA_TRSV_ADDR(0x34, 1),			0},
	{"TRSV 0x35"			,	PHY_PMA_TRSV_ADDR(0x35, 0),			0},
	{"TRSV 0x35"			,	PHY_PMA_TRSV_ADDR(0x35, 1),			0},
	{"TRSV 0x36"			,	PHY_PMA_TRSV_ADDR(0x36, 0),			0},
	{"TRSV 0x36"			,	PHY_PMA_TRSV_ADDR(0x36, 1),			0},
	{"TRSV 0x37"			,	PHY_PMA_TRSV_ADDR(0x37, 0),			0},
	{"TRSV 0x37"			,	PHY_PMA_TRSV_ADDR(0x37, 1),			0},
	{"TRSV 0x38"			,	PHY_PMA_TRSV_ADDR(0x38, 0),			0},
	{"TRSV 0x38"			,	PHY_PMA_TRSV_ADDR(0x38, 1),			0},
	{"TRSV 0x3a"			,	PHY_PMA_TRSV_ADDR(0x3a, 0),			0},
	{"TRSV 0x3a"			,	PHY_PMA_TRSV_ADDR(0x3a, 1),			0},
	{"TRSV 0x3b"			,	PHY_PMA_TRSV_ADDR(0x3b, 0),			0},
	{"TRSV 0x3b"			,	PHY_PMA_TRSV_ADDR(0x3b, 1),			0},
	{"TRSV 0x3c"			,	PHY_PMA_TRSV_ADDR(0x3c, 0),			0},
	{"TRSV 0x3c"			,	PHY_PMA_TRSV_ADDR(0x3c, 1),			0},
	{"TRSV 0x3d"			,	PHY_PMA_TRSV_ADDR(0x3d, 0),			0},
	{"TRSV 0x3d"			,	PHY_PMA_TRSV_ADDR(0x3d, 1),			0},
	{"TRSV 0x3e"			,	PHY_PMA_TRSV_ADDR(0x3e, 0),			0},
	{"TRSV 0x3e"			,	PHY_PMA_TRSV_ADDR(0x3e, 1),			0},
	{"TRSV 0x3f"			,	PHY_PMA_TRSV_ADDR(0x3f, 0),			0},
	{"TRSV 0x3f"			,	PHY_PMA_TRSV_ADDR(0x3f, 1),			0},
	{"TRSV 0x40"			,	PHY_PMA_TRSV_ADDR(0x40, 0),			0},
	{"TRSV 0x40"			,	PHY_PMA_TRSV_ADDR(0x40, 1),			0},
	{"TRSV 0x41"			,	PHY_PMA_TRSV_ADDR(0x41, 0),			0},
	{"TRSV 0x41"			,	PHY_PMA_TRSV_ADDR(0x41, 1),			0},
	{"TRSV 0x42"			,	PHY_PMA_TRSV_ADDR(0x42, 0),			0},
	{"TRSV 0x42"			,	PHY_PMA_TRSV_ADDR(0x42, 1),			0},
	{"TRSV 0x43"			,	PHY_PMA_TRSV_ADDR(0x43, 0),			0},
	{"TRSV 0x43"			,	PHY_PMA_TRSV_ADDR(0x43, 1),			0},
	{"TRSV 0x44"			,	PHY_PMA_TRSV_ADDR(0x44, 0),			0},
	{"TRSV 0x44"			,	PHY_PMA_TRSV_ADDR(0x44, 1),			0},
	{"TRSV 0x45"			,	PHY_PMA_TRSV_ADDR(0x45, 0),			0},
	{"TRSV 0x45"			,	PHY_PMA_TRSV_ADDR(0x45, 1),			0},
	{"TRSV 0x46"			,	PHY_PMA_TRSV_ADDR(0x46, 0),			0},
	{"TRSV 0x46"			,	PHY_PMA_TRSV_ADDR(0x46, 1),			0},
	{"TRSV 0x47"			,	PHY_PMA_TRSV_ADDR(0x47, 0),			0},
	{"TRSV 0x47"			,	PHY_PMA_TRSV_ADDR(0x47, 1),			0},
	{"TRSV 0x48"			,	PHY_PMA_TRSV_ADDR(0x48, 0),			0},
	{"TRSV 0x48"			,	PHY_PMA_TRSV_ADDR(0x48, 1),			0},
	{"TRSV 0x49"			,	PHY_PMA_TRSV_ADDR(0x49, 0),			0},
	{"TRSV 0x49"			,	PHY_PMA_TRSV_ADDR(0x49, 1),			0},
	{"TRSV 0x4a"			,	PHY_PMA_TRSV_ADDR(0x4a, 0),			0},
	{"TRSV 0x4a"			,	PHY_PMA_TRSV_ADDR(0x4a, 1),			0},
	{"TRSV 0x4b"			,	PHY_PMA_TRSV_ADDR(0x4b, 0),			0},
	{"TRSV 0x4b"			,	PHY_PMA_TRSV_ADDR(0x4b, 1),			0},
	{"TRSV 0x4c"			,	PHY_PMA_TRSV_ADDR(0x4c, 0),			0},
	{"TRSV 0x4c"			,	PHY_PMA_TRSV_ADDR(0x4c, 1),			0},
	{"TRSV 0x4d"			,	PHY_PMA_TRSV_ADDR(0x4d, 0),			0},
	{"TRSV 0x4d"			,	PHY_PMA_TRSV_ADDR(0x4d, 1),			0},
	{"TRSV 0x4e"			,	PHY_PMA_TRSV_ADDR(0x4e, 0),			0},
	{"TRSV 0x4e"			,	PHY_PMA_TRSV_ADDR(0x4e, 1),			0},
	{"TRSV 0x4f"			,	PHY_PMA_TRSV_ADDR(0x4f, 0),			0},
	{"TRSV 0x4f"			,	PHY_PMA_TRSV_ADDR(0x4f, 1),			0},
	{"TRSV 0x50"			,	PHY_PMA_TRSV_ADDR(0x50, 0),			0},
	{"TRSV 0x50"			,	PHY_PMA_TRSV_ADDR(0x50, 1),			0},
	{"TRSV 0x51"			,	PHY_PMA_TRSV_ADDR(0x51, 0),			0},
	{"TRSV 0x51"			,	PHY_PMA_TRSV_ADDR(0x51, 1),			0},
	{"TRSV 0x52"			,	PHY_PMA_TRSV_ADDR(0x52, 0),			0},
	{"TRSV 0x52"			,	PHY_PMA_TRSV_ADDR(0x52, 1),			0},
	{"TRSV 0x53"			,	PHY_PMA_TRSV_ADDR(0x53, 0),			0},
	{"TRSV 0x53"			,	PHY_PMA_TRSV_ADDR(0x53, 1),			0},
	{"TRSV 0x54"			,	PHY_PMA_TRSV_ADDR(0x54, 0),			0},
	{"TRSV 0x54"			,	PHY_PMA_TRSV_ADDR(0x54, 1),			0},
	{"TRSV 0x55"			,	PHY_PMA_TRSV_ADDR(0x55, 0),			0},
	{"TRSV 0x55"			,	PHY_PMA_TRSV_ADDR(0x55, 1),			0},
	{"TRSV 0x56"			,	PHY_PMA_TRSV_ADDR(0x56, 0),			0},
	{"TRSV 0x56"			,	PHY_PMA_TRSV_ADDR(0x56, 1),			0},
	{"TRSV 0x57"			,	PHY_PMA_TRSV_ADDR(0x57, 0),			0},
	{"TRSV 0x57"			,	PHY_PMA_TRSV_ADDR(0x57, 1),			0},
	{"TRSV 0x58"			,	PHY_PMA_TRSV_ADDR(0x58, 0),			0},
	{"TRSV 0x58"			,	PHY_PMA_TRSV_ADDR(0x58, 1),			0},
	{"TRSV 0x59"			,	PHY_PMA_TRSV_ADDR(0x59, 0),			0},
	{"TRSV 0x59"			,	PHY_PMA_TRSV_ADDR(0x59, 1),			0},
	{"TRSV 0x5a"			,	PHY_PMA_TRSV_ADDR(0x5a, 0),			0},
	{"TRSV 0x5a"			,	PHY_PMA_TRSV_ADDR(0x5a, 1),			0},
	{"TRSV 0x5b"			,	PHY_PMA_TRSV_ADDR(0x5b, 0),			0},
	{"TRSV 0x5b"			,	PHY_PMA_TRSV_ADDR(0x5b, 1),			0},
	{"TRSV 0x5c"			,	PHY_PMA_TRSV_ADDR(0x5c, 0),			0},
	{"TRSV 0x5c"			,	PHY_PMA_TRSV_ADDR(0x5c, 1),			0},
	{"TRSV 0x5d"			,	PHY_PMA_TRSV_ADDR(0x5d, 0),			0},
	{"TRSV 0x5d"			,	PHY_PMA_TRSV_ADDR(0x5d, 1),			0},
	{"TRSV 0x5e"			,	PHY_PMA_TRSV_ADDR(0x5e, 0),			0},
	{"TRSV 0x5e"			,	PHY_PMA_TRSV_ADDR(0x5e, 1),			0},
	{"TRSV 0x5f"			,	PHY_PMA_TRSV_ADDR(0x5f, 0),			0},
	{"TRSV 0x5f"			,	PHY_PMA_TRSV_ADDR(0x5f, 1),			0},
	{"TRSV 0x60"			,	PHY_PMA_TRSV_ADDR(0x60, 0),			0},
	{"TRSV 0x60"			,	PHY_PMA_TRSV_ADDR(0x60, 1),			0},
	{"TRSV 0x61"			,	PHY_PMA_TRSV_ADDR(0x61, 0),			0},
	{"TRSV 0x61"			,	PHY_PMA_TRSV_ADDR(0x61, 1),			0},
	{"TRSV 0x62"			,	PHY_PMA_TRSV_ADDR(0x62, 0),			0},
	{"TRSV 0x62"			,	PHY_PMA_TRSV_ADDR(0x62, 1),			0},
	{"TRSV 0x63"			,	PHY_PMA_TRSV_ADDR(0x63, 0),			0},
	{"TRSV 0x63"			,	PHY_PMA_TRSV_ADDR(0x63, 1),			0},
	{"TRSV 0x64"			,	PHY_PMA_TRSV_ADDR(0x64, 0),			0},
	{"TRSV 0x64"			,	PHY_PMA_TRSV_ADDR(0x64, 1),			0},
	{"TRSV 0x65"			,	PHY_PMA_TRSV_ADDR(0x65, 0),			0},
	{"TRSV 0x65"			,	PHY_PMA_TRSV_ADDR(0x65, 1),			0},
	{"TRSV 0x66"			,	PHY_PMA_TRSV_ADDR(0x66, 0),			0},
	{"TRSV 0x66"			,	PHY_PMA_TRSV_ADDR(0x66, 1),			0},
	{"TRSV 0x67"			,	PHY_PMA_TRSV_ADDR(0x67, 0),			0},
	{"TRSV 0x67"			,	PHY_PMA_TRSV_ADDR(0x67, 1),			0},
	{"TRSV 0x68"			,	PHY_PMA_TRSV_ADDR(0x68, 0),			0},
	{"TRSV 0x68"			,	PHY_PMA_TRSV_ADDR(0x68, 1),			0},
	{"TRSV 0x6a"			,	PHY_PMA_TRSV_ADDR(0x6a, 0),			0},
	{"TRSV 0x6a"			,	PHY_PMA_TRSV_ADDR(0x6a, 1),			0},
	{"TRSV 0x6b"			,	PHY_PMA_TRSV_ADDR(0x6b, 0),			0},
	{"TRSV 0x6b"			,	PHY_PMA_TRSV_ADDR(0x6b, 1),			0},
	{"TRSV 0x6c"			,	PHY_PMA_TRSV_ADDR(0x6c, 0),			0},
	{"TRSV 0x6c"			,	PHY_PMA_TRSV_ADDR(0x6c, 1),			0},
	{"TRSV 0x6d"			,	PHY_PMA_TRSV_ADDR(0x6d, 0),			0},
	{"TRSV 0x6d"			,	PHY_PMA_TRSV_ADDR(0x6d, 1),			0},
	{"TRSV 0x6e"			,	PHY_PMA_TRSV_ADDR(0x6e, 0),			0},
	{"TRSV 0x6e"			,	PHY_PMA_TRSV_ADDR(0x6e, 1),			0},
	{"TRSV 0x6f"			,	PHY_PMA_TRSV_ADDR(0x6f, 0),			0},
	{"TRSV 0x6f"			,	PHY_PMA_TRSV_ADDR(0x6f, 1),			0},
	{"TRSV 0x70"			,	PHY_PMA_TRSV_ADDR(0x70, 0),			0},
	{"TRSV 0x70"			,	PHY_PMA_TRSV_ADDR(0x70, 1),			0},
	{"TRSV 0x71"			,	PHY_PMA_TRSV_ADDR(0x71, 0),			0},
	{"TRSV 0x71"			,	PHY_PMA_TRSV_ADDR(0x71, 1),			0},
	{"TRSV 0x72"			,	PHY_PMA_TRSV_ADDR(0x72, 0),			0},
	{"TRSV 0x72"			,	PHY_PMA_TRSV_ADDR(0x72, 1),			0},
	{"TRSV 0x73"			,	PHY_PMA_TRSV_ADDR(0x73, 0),			0},
	{"TRSV 0x73"			,	PHY_PMA_TRSV_ADDR(0x73, 1),			0},
	{"TRSV 0x74"			,	PHY_PMA_TRSV_ADDR(0x74, 0),			0},
	{"TRSV 0x74"			,	PHY_PMA_TRSV_ADDR(0x74, 1),			0},
	{"TRSV 0x75"			,	PHY_PMA_TRSV_ADDR(0x75, 0),			0},
	{"TRSV 0x75"			,	PHY_PMA_TRSV_ADDR(0x75, 1),			0},
	{"TRSV 0x76"			,	PHY_PMA_TRSV_ADDR(0x76, 0),			0},
	{"TRSV 0x76"			,	PHY_PMA_TRSV_ADDR(0x76, 1),			0},
	{"TRSV 0x77"			,	PHY_PMA_TRSV_ADDR(0x77, 0),			0},
	{"TRSV 0x77"			,	PHY_PMA_TRSV_ADDR(0x77, 1),			0},
	{"TRSV 0x78"			,	PHY_PMA_TRSV_ADDR(0x78, 0),			0},
	{"TRSV 0x78"			,	PHY_PMA_TRSV_ADDR(0x78, 1),			0},
	{"TRSV 0x79"			,	PHY_PMA_TRSV_ADDR(0x79, 0),			0},
	{"TRSV 0x79"			,	PHY_PMA_TRSV_ADDR(0x79, 1),			0},
	{"TRSV 0x7a"			,	PHY_PMA_TRSV_ADDR(0x7a, 0),			0},
	{"TRSV 0x7a"			,	PHY_PMA_TRSV_ADDR(0x7a, 1),			0},
	{"TRSV 0x7b"			,	PHY_PMA_TRSV_ADDR(0x7b, 0),			0},
	{"TRSV 0x7b"			,	PHY_PMA_TRSV_ADDR(0x7b, 1),			0},
	{"TRSV 0x7c"			,	PHY_PMA_TRSV_ADDR(0x7c, 0),			0},
	{"TRSV 0x7c"			,	PHY_PMA_TRSV_ADDR(0x7c, 1),			0},
	{"TRSV 0x7d"			,	PHY_PMA_TRSV_ADDR(0x7d, 0),			0},
	{"TRSV 0x7d"			,	PHY_PMA_TRSV_ADDR(0x7d, 1),			0},
	{"TRSV 0x7e"			,	PHY_PMA_TRSV_ADDR(0x7e, 0),			0},
	{"TRSV 0x7e"			,	PHY_PMA_TRSV_ADDR(0x7e, 1),			0},
	{"TRSV 0x7f"			,	PHY_PMA_TRSV_ADDR(0x7f, 0),			0},
	{"TRSV 0x7f"			,	PHY_PMA_TRSV_ADDR(0x7f, 1),			0},
...
static struct ufs_attr_log ufs_cfg_log_attr[] = {
	...
	{UIC_ARG_MIB_SEL(0x028B, 0),	0, 0},
	{UIC_ARG_MIB_SEL(0x028B, 1),	0, 0},
	{UIC_ARG_MIB_SEL(0x029A, 0),	0, 0},
	{UIC_ARG_MIB_SEL(0x029A, 1),	0, 0},
	{UIC_ARG_MIB_SEL(0x0277, 0),	0, 0},
	{UIC_ARG_MIB_SEL(0x0277, 1),	0, 0},
...
static void exynos_ufs_pma_dump(struct exynos_ufs *ufs)
{
	int i;

	dev_err(ufs->dev, ": --------------------------------------------------- \n");
	dev_err(ufs->dev, ": \t\tMPHY PMA REGION DUMP\n");
	dev_err(ufs->dev, ": --------------------------------------------------- \n");
	for (i = 0; i < ufs->phy.pma_size; i += 4)
		dev_err(ufs->dev, "offset 0x%04X: 0x%02X\n", i, phy_pma_readl(ufs, i));
	dev_err(ufs->dev, ": --------------------------------------------------- \n");
...
static void exynos_ufs_tp_mon(struct work_struct *work)
{
	struct exynos_ufs *ufs = container_of(work, struct exynos_ufs,
			tp_mon.work);
	struct ufs_hba *hba = NULL; //ufs->hba;
...
static int exynos_ufs_populate_dt_phy(struct device *dev, struct exynos_ufs *ufs)
{
	...
	phy->pma_size = resource_size(&io_res);
