...
extern int parse_options_remount(struct super_block *sb, char *options,
		int silent, struct sdcardfs_vfsmount_options *vfsopts);
...
/* Per-view permissions are supplied by permission2/getattr. */
static inline void sdcardfs_copy_and_fix_attrs(struct inode *dest, const struct inode *src)
{
	dest->i_mode = (src->i_mode & S_IFMT) | 0775;
